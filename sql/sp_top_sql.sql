WITH snaps AS
(
    SELECT s.snap_id,s.snap_time,i.dbid,i.instance_number  /*+ materialize */
...
snap_top_cp AS (  
 ...
 data AS ( SELECT   sh.dbid,sh.snap_id,sh.snap_time, 
          stat.sql_id,  
          stat.plan_hash_value,  
 ...
 ORDER BY s.top_pct,s.snap_time DESC
