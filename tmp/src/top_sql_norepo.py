...
def main(args):
    ...
    #   conn = cx_Oracle.connect(user="SYS",password="K@re@72@@@",mode=cx_Oracle.SYSDBA,odsn=dsn)
    #else:
    ...
    sqlfile = os.environ.get('AWR_DEV_HOME') + "/sql/" + "top_sql.sql"
    ...
    conn = cx_Oracle.connect(user="SYS",password="K@re@72@@@",mode=cx_Oracle.SYSDBA,dsn=odsn)
